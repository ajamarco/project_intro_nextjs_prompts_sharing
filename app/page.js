//this page.js file is the home page of your application. I.e. when you go to localhost:3000/ this is the page that is rendered.
//this is pretty much a react components, but it's rendered in the server side.

//to make this page render in the client side we use the following line
// "use client";

// client side rendering is useful when you want to render something that is not available in the server side, like managing the state of a component.
